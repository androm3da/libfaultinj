...
`LIBFAULT_ERROR_{READ,WRITE,LSEEK}_ERRNO` to your target's errno.
...
For example:
    ...
    $ LD_PRELOAD=libfaultinj.so LIBFAULTINJ_DELAY_PATH=./testing_dir/ LIBFAULTINJ_DELAY_READ_MS=10000 \time cat ./testing_dir/foo.txt
    ...
    $ LIBFAULTINJ_DELAY_PATH=./testing_dir/ LIBFAULTINJ_DELAY_READ_MS=10000 \time cat ./testing_dir/foo.txt
